...
MARCAS = [
    ...
    "GOMIX", "NATURAL HEALTH", "SIENNA", "UKN", "NEPRO",
    ...
    "ALERCROM", "ALESIRAM", "ALLEANCE", "ALPHAGAN", "ANHIGOT",
    ...
    # --- Ampliación: submarcas / líneas compuestas (jul 2026) ---
    # farmaciasguadalajara.com no distingue "submarca" como campo aparte: sus
    # descripciones anteponen la línea al nombre de la marca paraguas
    # (ej. "Shampoo Pantene PRO-V Restauración"). Para que el parser capture
    # ese bloque completo como MARCA (en vez de partirlo en MARCA+DETALLE),
    # se agregan aquí como entradas de varias palabras. Al estar ordenadas
    # por longitud (ver _MARCAS_ORDENADAS), estas variantes largas se prueban
    # antes que la marca corta, así que no rompen la detección existente.
    # Cuidado capilar
    "PANTENE PRO-V", "PANTENE PRO V", "HERBAL ESSENCES BIO:RENEW",
    "ELVIVE TOTAL REPAIR", "FRUCTIS HIDRA COCO", "SEDAL CERAMIDAS",
    "PALMOLIVE OPTIMS", "DOVE NUTRITIVE SOLUTIONS", "TRESEMMÉ KERATIN SMOOTH",
    "TRESEMME KERATIN SMOOTH", "SCHWARZKOPF GLISS", "OLD SPICE SWAGGER",
    "ÁRBOL VERDE", "ARBOL VERDE", "FOLICURÉ", "FOLICURE",
    # Cuidado de la piel / dermo
    "NIVEA SUN", "NIVEA MEN SENSITIVE", "CETAPHIL PRO", "EUCERIN DERMOPURE",
    "LA ROCHE POSAY EFFACLAR", "LA ROCHE POSAY ANTHELIOS", "CERAVE SA",
    "AVENE CLEANANCE", "AVÈNE CLEANANCE", "NEUTROGENA HYDRO BOOST",
    "OLAY REGENERIST", "BIODERMA SENSIBIO", "BIODERMA SEBIUM",
    "ISDIN FOTOPROTECTOR", "ECLIPSOL ULTRA",
    # Glucómetros / control de diabetes (líneas de accesorios)
    "ACCU-CHEK PERFORMA", "ACCU-CHEK GUIDE", "ACCU-CHEK SOFTCLIX",
    "ACCU-CHEK INSTANT", "ACCU-CHEK ACTIVE", "ACCU CHEK PERFORMA",
    "ACCU CHEK GUIDE", "ACCU CHEK INSTANT", "ACCU CHEK ACTIVE",
    "ONE TOUCH ULTRA", "ONE TOUCH SELECT", "ONE TOUCH VERIO",
    "FREESTYLE OPTIUM", "FREESTYLE LIBRE",
    # Fórmulas infantiles (etapas/líneas)
    "NAN OPTIMAL PRO", "NAN 1", "NAN 2", "NAN 3", "NAN 4",
    "SIMILAC AVANZA", "SIMILAC TOTAL COMFORT", "ENFAGROW PREMIUM",
    "ENFAMIL PREMIUM", "FRISOLAC GOLD", "S-26 GOLD", "S26 GOLD",
    "NUTRIBEN INNOVA",
    # Pañales (etapas/líneas)
    "HUGGIES SUPREME", "HUGGIES NATURAL CARE", "KLEENBEBE COMODISEC",
    # Higiene femenina (líneas)
    "SABA BUENAS NOCHES", "SABA V-CALMA", "ALWAYS ULTRAFINAS",
    "TAMPAX PEARL", "STAYFREE NIGHT",
    # Salud sexual (líneas)
    "SICO SENSITIVE", "SICO INVISIBLE", "DUREX RETARDANTE", "TROJAN PLEASURE",
    # Vitaminas / suplementos (líneas)
    "CENTRUM PERFORMANCE", "CALTRATE 600",
    # Bucal (líneas)
    "COLGATE TOTAL", "ORAL-B PRO-SALUD",
    "ORAL B PRO-SALUD", "SENSODYNE REPAIR & PROTECT",
    # Higiene del hogar / papel (líneas)
    "PÉTALO RENDIMAX", "PETALO RENDIMAX", "KLEENEX COTTONELLE ELEGANCE",
    # --- Ampliación: autoservicio, hogar, alimentos y bebidas (jul 2026) ---
    # Hogar: limpieza / lavandería adicional
    "WINDEX", "BRASSO", "BREF", "TENA LADY", "CHUCHUWASH", "BNB SOLUTIONS",
    # Hogar: accesorios de limpieza
    "COPAR", "TEPA",
    # Hogar: jardín / ferretería / pilas / electrónicos
    "RAID", "H24", "SURTEK", "CLIPPER", "PRODKEN",
    # Papelería / mochilas / regalo
    "RUZ",
    # Alimentos: aceites / despensa básica
    "ALEO", "HOGAR OMEGA", "ZULKA",
    # Alimentos: arroz / frijol / semillas
    "RANCH STYLE", "REY", "LA MERCED", "ITALRISO", "PROGRESO",
    "VERDE VALLE", "DOROTEA", "AROMAS DEL CAMPO",
    # Alimentos: sopas / pastas / instantáneos
    "NISSIN", "TRES ESTRELLAS", "HELLMANN'S", "HELLMANNS", "YEMINA",
    # Alimentos: cuidado facial/capilar vendido en pasillo de despensa (San Luis, Jaloma, Suavella)
    "SUAVELLA", "JALOMA", "ATLANTA",
    # Bebidas: agua / saborizadas / jugos
    "BE LIGHT", "COCO DREAM", "A DE COCO", "HAPPY BABY", "PATRONA MÍA",
    "PATRONA MIA", "SKARCH", "JUMEX FRUTZZO",
    # Alimentos: botanas / dulcería
    "BOTANUKAS", "CASA TAPATÍA", "CASA TAPATIA", "SLIM POP", "FLIPY",
    "OKKO SUPER FOODS", "BIG MIX", "BOKADOS",
    # Alimentos: lácteos / edulcorantes / repostería
    "OIKOS", "CANDEREL", "MAIZENA", "INSPIREKA",
    # --- Ampliación: mascotas, congelados, dermo/farmacia, electrónicos (jul 2026) ---
    # Mascotas: alimento / higiene / accesorios adicional
    "PURINA ONE", "FEBREZE", "BIOZONE", "GATO CONSENTIDO", "THANKFUL DOG",
    "PERRÍSIMO",
    # Alimentos: congelados / carnes frías / preparados adicional
    "EL CAZO", "CHIMEX", "CHATA", "ISADORA", "KARNE GARIBALDI",
    # Farmacia: dermatología adicional (laboratorios y marcas propias)
    "AVESOP", "BABARIA", "GALDERMA", "SODIMEL", "DERMALIVE", "VITACILINA",
    "VASTIONIN", "IPHARMA", "PRANOSINE", "SKINMAR", "ANDRÓMACO", "HIPOGLOS",
    "RAPIVIR",
    # Electrónicos: audio / cómputo adicional
    "SOUNDBITT",
    # --- Ampliación: belleza/cosméticos y bebés (jul 2026) ---
    # Cosméticos / maquillaje adicional
    "DIVA", "EASY BEAUTY", "YUYA",
    # Bebés: toallitas húmedas / cuidado adicional
    "PETIT CARE", "AQUAWIPES", "BABY SOFT", "KIMBIES", "PACIFICA",
    # --- Ampliación: desodorantes y antitranspirantes (jul 2026) ---
    # "LADY SPEED STICK" se agrega completa (3 palabras) para que tenga
    # prioridad sobre la entrada más corta "SPEED STICK" ya existente,
    # y así no deje "LADY" suelto en el detalle.
    "LADY SPEED STICK", "CLEAN & DRY", "BRUT", "SKINDRY",
]
